...
public class buyProductTestCase {
	...
	public void testMain() {
		...
		add.checkoutSummary();
		newUser.newAccount("nikolasbbbbbs@dbteste.com");
		String addressAccount = "Rua Patos, 123";
		String cityAccount = "Porto Alegre";
		newUser.personalInformation("Nikolas", "Souza", "password", addressAccount, cityAccount, "01234", "1589652389");
